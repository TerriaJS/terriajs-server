...
function loadCommandLine() {
    var yargs = require('yargs')
        ...
        'multi-config-file' : {
            'description' : 'File containing mapping for multi-tenant mode'
        },
        'proxy-auth' : {
...
options.init = function(quiet) {
    ...
    this.multiConfig = getConfig(this.multiConfigFile, 'multi-config', 'multi-tenant config not supplied');
    return options;
};
