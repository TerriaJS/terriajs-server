...
module.exports = function(options) {
    ...
    endpoint('/proxy', proxy(proxyOptions).router);
    ...
    if (options.settings.keys !== undefined) {
        endpoint('/proxywithkey', require('./controllers/proxyWithKey')(proxyOptions, options.settings.keys));
    }
