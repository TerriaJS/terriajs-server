...
export default function (options) {
  ...
  var esriTokenAuthRouter = esriTokenAuth(options.settings.esriTokenAuth);
  ...
  var shareService = share(options.hostName, options.port, {
  ...
  if (options.settings && options.settings.singlePageRouting) {
    var singlePageRoutingService = singlePageRouting(
      options,
      options.settings.singlePageRouting
    );
