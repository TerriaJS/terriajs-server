...
module.exports = function(options) {
    ...
    app.get('*', function (request, response, next) {
        const prerendered = path.resolve(options.wwwroot, request.path, 'index.html');
        // const fallbackIndex = path.resolve(options.wwwroot, 'index.html');
        ...
        // else {
        //     response.sendFile(fallbackIndex);
        // }
    });
