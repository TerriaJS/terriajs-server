...
app.use('/convert', require('./convert')(options).router); // OGR2OGR wrapper to allow supporting file types like Shapefile.
...
app.use('/init', require('./initfile')(initPaths, error404, path.dirname(options.configFile)));
/*
...
var feedbackService = require('./feedback')(options.settings.feedback);
if (feedbackService) {
    app.use('/feedback', feedbackService);
}
var shareService = require('./share')(options.settings.shareUrlPrefixes, options.settings.newShareUrlPrefix);
if (shareService) {
