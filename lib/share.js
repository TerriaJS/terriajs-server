...
var gistAPI = 'https://api.github.com/gistsXX';
...
//echo '{ "test": "me" }' | http post localhost:3001/share/new
function makeGist(serviceOptions, body, callback) {
    var gistFile = {};
    gistFile[serviceOptions.gistFilename || 'usercatalog.json'] = { content: JSON.stringify(body) };
...
// Test: http localhost:3001/share/resolve/g-98e01625db07a78d23b42c3dbe08fe20
...
module.exports = function(shareUrlPrefixes, newShareUrlPrefix) {
    ...
    router.use(bodyParser.json()); // probably don't need to do this
    ...
    router.post('/new', function(req, res, next) {
        ...
        makeGist(shareUrlPrefixes[newShareUrlPrefix], req.body).then(function(id) {
            ...
            res.json({ id: id, path: req.baseUrl + '/resolve/' + id });
