...
module.exports = function(options: any) {
  ...
  function proxyAllowedHost(host: string) {
  ...
  function buildReqHandler(httpVerb: string) {
    function handler(req: any, res: any, next: any) {
      return doProxy(req, res, next, req.retryWithoutAuth, function(
        remoteUrl: any,
        filteredRequestHeaders: any,
        proxy: any,
        maxAgeSeconds: any
      ) {
        try {
          var proxiedRequest = request({
            ...
            proxy: proxy,
            body: req.body,
            followRedirect: function(response: any) {
 ...
 */
function processHeaders(headers: any, maxAgeSeconds: number) {
