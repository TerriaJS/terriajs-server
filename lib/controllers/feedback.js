...
module.exports = function(options) {
    ...
    router.post('/', function(req, res, next) {
        ...
        var parsedCreateIssueUrl = url.parse(runtimeOptions.issuesUrl, true);
        // parsedCreateIssueUrl.query.access_token = options.accessToken;
        parsedCreateIssueUrl.query.access_token = runtimeOptions.accessToken;
        ...
        request({
            ...
            headers: {
                ...
                'User-Agent': runtimeOptions.userAgent || 'TerriaBot (TerriaJS Feedback)',
                'Accept': 'application/vnd.github.v3+json'
            },
            body: JSON.stringify({
                title: parameters.title ? parameters.title : 'User Feedback',
                // body: formatBody(req, parameters, options.additionalParameters)
                body: formatBody(req, parameters, runtimeOptions.additionalParameters)
            })
