...
module.exports = function(shareUrlPrefixes, newShareUrlPrefix, hostName) {
    if (!shareUrlPrefixes) {
        return;
    }
    ...
    router.post('/', function(req, res, next) {
        ...
        makeGist(shareUrlPrefixes[newShareUrlPrefix], req.body).then(function(id) {
            ...
            var resolvePath = req.baseUrl + '/' + id;
            var resolveUrl = 'http://' + req.hostName + resolvePath;
            res .location(resolveUrl) // We don't know if we're behind HTTPS...
                .json({ id: id, path: resolvePath, url: resolveUrl });
