...
module.exports = function(shareUrlPrefixes, newShareUrlPrefix, hostName) {
    ...
    router.post('/', function(req, res, next) {
        ...
        makeGist(shareUrlPrefixes[newShareUrlPrefix], req.body).then(function(id) {
            ...
            var resolveURL = req.baseUrl + '/' + id;
            res .location('http://' + req.headers.host + resolveURL) // We don't know if we're behind HTTPS...
                .json({ id: id, path: resolveURL, url: 'http://' + req.headers.host + resolveURL });
