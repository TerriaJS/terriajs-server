...
export default function shareController(
  ...
  router.post("/", function(req: any, res: any, next: any) {
    const runtimeOptions = res.locals.settingsForHost;
    const newShareUrlPrefix = runtimeOptions.newShareUrlPrefix;
    const shareUrlPrefixes = runtimeOptions.shareUrlPrefixes;

    if (
      newShareUrlPrefix === undefined ||
      !shareUrlPrefixes[newShareUrlPrefix]
    ) {
    ...
    const serviceOptions = shareUrlPrefixes[newShareUrlPrefix];
  ...
  router.get("/:id", function(req: any, res: any, next: any) {
    ...
    const serviceOptions = shareUrlPrefixes[prefix];
    if (!serviceOptions) {
      console.error(
